...
abstract public class BindingListHelper
{
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (BindingListHelper.id (), "BindingList", __typeCode);
    }
    return __typeCode;
  }
  ...
  public static Binding[] read (org.omg.CORBA.portable.InputStream istream)
  {
    ...
    value = new Binding[_len0];
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = BindingHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, Binding[] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      BindingHelper.write (ostream, value[_i0]);
  }
