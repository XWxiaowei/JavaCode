...
abstract public class NameDynAnyPairSeqHelper
{
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (NameDynAnyPairSeqHelper.id (), "NameDynAnyPairSeq", __typeCode);
    }
    return __typeCode;
  }
  ...
  {
    NameDynAnyPair value[] = null;
    int _len0 = istream.read_long ();
    value = new NameDynAnyPair[_len0];
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = NameDynAnyPairHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, NameDynAnyPair[] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      NameDynAnyPairHelper.write (ostream, value[_i0]);
  }
