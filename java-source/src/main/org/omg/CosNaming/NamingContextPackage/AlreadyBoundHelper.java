...
abstract public class AlreadyBoundHelper
{
    ...
    if (__typeCode == null)
    {
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          __typeCode = org.omg.CORBA.ORB.init ().create_exception_tc (AlreadyBoundHelper.id (), "AlreadyBound", _members0);
          __active = false;
        }
      }
    }
  ...
  public static AlreadyBound read (org.omg.CORBA.portable.InputStream istream)
  {
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, AlreadyBound value)
  {
